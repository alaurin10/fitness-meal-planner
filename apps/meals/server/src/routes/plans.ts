...
import { generateMealPlan } from "../services/anthropic.js";
import { fetchFitSchedule } from "../services/fitClient.js";
...
router.get("/current", requireAuth, async (req, res) => {
  ...
  const plan = await mealsPrisma.weeklyMealPlan.findFirst({
...
router.post("/generate", requireAuth, async (req, res) => {
  ...
  try {
    ...
    console.error("[meals plans] generate failed:", message);
